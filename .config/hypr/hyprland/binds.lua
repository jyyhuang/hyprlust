...
hl.bind(mainMod .. " + ALT + E", hl.dsp.window.move({ workspace = "special:magic" }))
...
hl.bind(
	mainMod .. " + SPACE",
	hl.dsp.exec_cmd("rofi -modi Clipboard:~/.config/scripts/cliphist-rofi-img -show Clipboard -show-icons")
)

-- wallpaper
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("~/.config/scripts/wofi-paper.sh"))
