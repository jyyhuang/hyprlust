...
function module.apply_to_config(config)
	...
	config.colors = {
		tab_bar = {
			background = hex2rgba(wallust_colors.special.background, 0.5),
			active_tab = {
				bg_color = wallust_colors.colors.color1,
			...
			inactive_tab = {
				...
				fg_color = wallust_colors.colors.color1,
				italic = false,
				strikethrough = true,
			},
			inactive_tab_hover = {
				bg_color = wallust_colors.colors.color6,
				fg_color = wallust_colors.colors.color14,
				italic = false,
			},
			new_tab = {
	...
	wezterm.on("update-status", function(window, pane)
		...
		window:set_right_status(wezterm.format({
			{ Background = { Color = hex2rgba(wallust_colors.special.background, 0.5) } },
			...
			{ Text = " ~" },
			{ Text = cwd .. " " },
			{ Foreground = { Color = wallust_colors.colors.color10 } },
			{ Text = "" },
			{ Background = { Color = wallust_colors.colors.color10 } },
			{ Foreground = { Color = wallust_colors.colors.color0 } },
